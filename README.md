...
**Note from author**: Alacpretty is currently being re-written from scratch without the aid from Termui. Checkout out the repo <a href="https://github.com/solidiquis/alacpretty_v2">here</a>.
